...
function AdminDashboard() {
    ...
    return (
        <AdminLayout>
            {/* Header section can be handled by layout or kept here for title */}
            <div className="mb-8">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                ...
                >
                    ...
                    <div className="mt-4 flex items-center text-sm">
                        ...
                        <span className="text-gray-500 ml-1">Today</span>
                        <span className="mx-2 text-gray-300">|</span>
                        <span className="text-green-600 font-semibold">{((stats.revenue.monthly / stats.revenue.total) * 100).toFixed(1)}%</span>
